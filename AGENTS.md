...
- Never work on `main`. Create every branch from `main`.
- Keep at most ten registered worktrees. Never force a removal, and never
  remove a dirty or unintegrated one. If you cannot get under the limit safely,
  ask what to remove.

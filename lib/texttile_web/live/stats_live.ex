      ...
      <div class="max-w-[1060px] mx-auto px-[14px] md:px-6 pt-[22px] md:pt-[30px] pb-[90px]">
        ...
        <div id="statsFigures" class="grid grid-cols-1 md:grid-cols-3 border-y border-rule">
          <div class="fig py-4 md:pr-5">
            ...
            <div class="l">{gettext("views, last %{days} days", days: @window)}</div>
          </div>
          <div class="fig py-4 md:px-5 border-t border-hair md:border-t-0 md:border-l md:border-l-hair">
            ...
            <div class="l">{gettext("people, last %{days} days", days: @window)}</div>
          </div>
          <div class="fig py-4 md:px-5 border-t border-hair md:border-t-0 md:border-l md:border-l-hair">
        ...
        <h2 class="sec-h">{gettext("Views, last %{days} days", days: @window)}</h2>
        <.day_chart id="dayChart" days={@days} />

        <h2 class="sec-h">{gettext("Top entries, all time")}</h2>
        <p :if={@top == []} class="note" id="topEmpty">
          {gettext("No entry has been read yet. The first reader who opens one puts it here.")}
        </p>
        ...
        <h2 class="sec-h">{gettext("Referrers, last %{days} days", days: @window)}</h2>
        ...
        <h2 :if={@pages != []} class="sec-h">
          {gettext("Other addresses, last %{days} days", days: @window)}
        </h2>

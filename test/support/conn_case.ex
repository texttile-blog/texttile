defmodule TexttileWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use TexttileWeb.ConnCase, async: true`, although
  ...
  @doc "Logs the given user into the test connection via a fresh session."
  def log_in_user(conn, user) do
    token = Texttile.Accounts.create_session(user)

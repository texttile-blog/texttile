defmodule Texttile.Repo.Migrations.AddAdminMarksToComments do
  use Ecto.Migration

  def change do
    alter table(:comments) do
      # The trash: the moment the row goes for good. Set means deleted,
      # and no list in the admin area and no reader page shows it any more.
      add :delete_after, :utc_datetime

      # An admin let this one comment through while its address is still
      ...
      # An admin changed the words. `updated_at` cannot say it: every
